...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An append-only record of a privileged action. Never edited, never deleted through the API.';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Draft/Published article. Draft state is Strapi's native Draft & Publish, guarded in the controller.";
...
export interface ApiCertificateCertificate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Issued when a student finishes every lesson and passes the course quiz.';
  ...
  attributes: {
    bestScore: Schema.Attribute.Integer;
    ...
    lessonsCompleted: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    student: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    studentLabel: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 120;
      }>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A comment on a blog post. A comment with a parent is a reply.';
    displayName: 'Comment';
    pluralName: 'comments';
  ...
  attributes: {
    ...
    postDocumentId: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A course owned by an instructor or created by a content manager.';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Join record between a student and a course. One per (student, course).';
...
export interface ApiLessonProgressLessonProgress
  ...
  info: {
    description: 'One row per (student, lesson) marked complete. `course` is denormalized so a course percentage is a single count query.';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A single unit of course content: either written text or a video URL.';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiNotificationNotification
  ...
  info: {
    description: 'An in-app message for one recipient, raised by something that happened elsewhere.';
...
export interface ApiPostLikePostLike extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One row per (user, post). Uniqueness is enforced in the controller.';
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One MCQ question. `correctIndex` is stripped before any student-facing response.';
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A graded submission. Score is computed server-side and stored, never sent by the client.';
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An MCQ quiz attached to a course, auto-graded on submit.';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A 1-5 rating with optional text, on a course or a blog post.';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    blogAccessRestricted: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    confirmationToken: Schema.Attribute.String & Schema.Attribute.Private;
    confirmed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    courseAccessRestricted: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
